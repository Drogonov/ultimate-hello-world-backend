...
export class AppService {
    ...
    async getHello(languageCode: string): Promise<IHelloResponse> {
        return {
            title: 'Say Hello',
            text: 'Hello World',
            emoji: '🏴',
    ...
    async getCountries(languageCode: string): Promise<ICountriesResponse> {
        return {
    ...
    async getInfo(languageCode: string): Promise<IInfoResponse> {
        return {
            title: "More Info",
    ...
    async getMagic(languageCode: string): Promise<IMagicResponse> {
        return {
